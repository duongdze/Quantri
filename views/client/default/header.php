...
<head>
    ...
    <meta name="description" content="VietTour – Nền tảng đặt tour du lịch trực tuyến hàng đầu Việt Nam">
    <!-- Google Fonts -->
...
<nav class="vt-navbar">
    <div class="container">
        ...
        <ul class="vt-nav-links">
            <li><a href="<?= BASE_URL ?>" class="<?= (($_GET['action'] ?? '/') === '/' || ($_GET['action'] ?? '/') === 'tour-list') ? 'active' : '' ?>">
                <i class="fas fa-home"></i> Trang chủ
            </a></li>
            <li><a href="<?= BASE_URL ?>?action=tour-list" class="<?= ($_GET['action'] ?? '') === 'tour-list' ? 'active' : '' ?>">
